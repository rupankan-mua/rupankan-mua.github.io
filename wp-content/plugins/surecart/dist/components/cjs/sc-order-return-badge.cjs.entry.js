...
const ScOrderReturnBadge = class {
    ...
    render() {
        return (index.h("sc-tag", { key: '74bd298bac7119d9527931e08c6036136c5bbfdf', type: type === null || type === void 0 ? void 0 : type[this === null || this === void 0 ? void 0 : this.status], pill: this.pill }, (status === null || status === void 0 ? void 0 : status[this.status]) || this.status));
    }
};
