...
const ScSubscriptionDetails = class {
    ...
    render() {
        return (index.h("div", { key: 'e640f90fc526a25d04e1158799925e35add636bf', class: "subscription-details" }, this.hasPendingUpdate && (index.h("div", { key: '0e7e066677cee4db69c50fa0ddf39dd98980b3bf' }, index.h("sc-tag", { key: '62a14d0f7a21916cc2b2beac59677606ebd34af8', size: "small", type: "warning" }, wp.i18n.__('Update Scheduled', 'surecart')))), index.h("sc-flex", { key: '53aadf662a0b9e7636533c5826c33d64f1e23c69', alignItems: "center", justifyContent: "flex-start" }, index.h("sc-text", { key: '3413194d4aa83659d5cade9febcc186ba15ea5c3', "aria-label": wp.i18n.sprintf(
            /* translators: %s: plan name */
            wp.i18n.__('Plan name - %s', 'surecart'), this.renderName()), style: { '--font-weight': 'var(--sc-font-weight-bold)' } }, this.renderName()), this.renderActivations()), !this.hideRenewalText && index.h("div", { key: '21c1b05e817851a95e7271db5aa15224e6fc8a63' }, this.renderRenewalText(), " "), index.h("slot", { key: '151181ebd2a31a01d1add55346e5f8b3fba50ff6' }), index.h("sc-dialog", { key: '78878beecf0c04c8344b820a6b27bdc31bf4ce78', label: wp.i18n.__('Activations', 'surecart'), onScRequestClose: () => (this.activationsModal = false), open: !!this.activationsModal }, index.h("sc-card", { key: '02d8fa942bb4489c8941c4e990410b59630b7c70', "no-padding": true, style: { '--overflow': 'hidden' } }, index.h("sc-stacked-list", { key: 'e920f9f546dbdfd4b9c6b27c4948090d37414794' }, (this.getActivations() || []).map(activation => {
        ...
        })))), this.showWarning() && (index.h("div", { key: '257a053e6a6b7ecf3c9644808e2cc4b95eb69d80' }, index.h("sc-tag", { key: 'fdba4baf6e5bf62047e9bd984f88220b92063abe', type: "warning" }, index.h("div", { key: 'b9784536b215cc8057e89ca8041453aade15ae26', class: "subscription-details__missing-method" }, index.h("sc-icon", { key: '23f26265d946a4a8d7475f15a1e41cce92124ba9', name: "alert-triangle" }), wp.i18n.__('Payment Method Missing', 'surecart')))))));
    }
...
const ScSubscriptionStatusBadge = class {
    ...
    render() {
        return (index.h("sc-tag", { key: '8df1acae7afef7676b2605c96b9d6543449774b0', "aria-label": wp.i18n.sprintf(wp.i18n.__('Plan Status - %s', 'surecart'), this.getText()), type: this.getType() }, this.getText()));
    }
};
