...
const ScMenuLabel = class {
    ...
    render() {
        return (index.h("div", { key: '26fc9f22244c77a9a3f4860cf5a0116b7cea12e5', part: "base", class: "menu-label" }, index.h("slot", { key: '2e605ae61c8972a689ccee0f2dfa5512dce6328f' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '96635ddb9848b5743e4f5bdcd1db5a1983f80ab9', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: '72fc82045b7fdb2d115ab3e1cab83489b8dad30c', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '7d70eca3d8e44f0ed36f3b9e7d00ef9875459dde', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, "aria-hidden": "true", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }), index.h("sc-dropdown", { key: '6ea50a2073832600201883a8dbfa9f25e38d67e0', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, index.h("slot", { key: 'fffd8d2e0b9448b0ea91de4321ecef8cfed3531b', name: "trigger", slot: "trigger" }, index.h("div", { key: 'a0cb09edcf2b925e626443c6432a9b2af32357b6', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: '78c78a01289c050b21084836c3c260b6da6fb9c6', class: "select__value" }, index.h("slot", { key: '001c3098398be6a88378326d25a7226dce0e28b8' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), index.h("sc-icon", { key: '6974c024252cf2241ee1657f5893195b61de4754', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: '852cd364357ea4d53e3438b61c21369674280d24', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: '4f97ca5be2c0187b508efc2cadffe7e5ee790168', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: 'dc2dd3be569be3f90869931a5a89df8ffdb3946f', style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: '77be9c2792ff5a2e9a9a116ad7850a0163b99fa3', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: 'ced1dc1c455839e5c8016d5e4116f728256f9808', class: "loading" }, index.h("sc-spinner", { key: 'fa1926055f158506912e05a6cc2d9ba193f80d0f', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: 'f801b63f2cb26e595da22d4833ea66ada776aed2', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: '884d39ccfd997eb7ac7b30f10a496b1c0d775aa0', name: "suffix" }))))));
    }
