...
const ScColumn = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c7cb7c951e62f93267e33ea002cb0dff92d76f05' }, index.h("slot", { key: '1282a2643e7f164b19c6694bda171f01b08f523a' })));
    }
};
...
const ScColumns = class {
    ...
    render() {
        return (index.h(index.Host, { key: '51377626c824cc8e97376288bb4572d36970a8c6', class: {
                'sc-columns': true,
            ...
            } }, index.h("slot", { key: 'bfea8246fa41a6fd1defcd3fb9b7e80427ecae52' })));
    }
};
