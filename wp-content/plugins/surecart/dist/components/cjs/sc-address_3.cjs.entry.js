...
const ScCheckbox = class {
    ...
    render() {
        ...
        return (index$1.h(Tag, { key: '7b92a916434d8644af219359244aa97643fd596d', part: "base", class: {
                'checkbox': true,
...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index$1.h(index$1.Fragment, { key: '1eec2bd50e1af01133a05a68bef033152214e840' }, index$1.h("sc-input", { key: 'faf3f0686fbd0cb095662dff38e0da085b9708e8', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), index$1.h("sc-input", { key: 'ee01b2247ddb0d456a9edf60b44fcef1a5ea6627', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
