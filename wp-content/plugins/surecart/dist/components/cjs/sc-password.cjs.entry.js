...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '2716f219e4a24ff8cc00496fd74a48d39973e375', class: "password" }, index.h("div", { key: 'e6dd27906d806e679cf7467e095cb381f55a22c7' }, index.h("sc-input", { key: '31d644acb4d0332d1dcf415e428619779901d3c0', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && index.h("small", { key: '8dd2219e42eae73e2cb3d53e0486bfeafcb1e21c', class: "password__hint" }, this.hintText)), this.confirmation && (index.h("div", { key: '8e0f96581bed7fa2730e8907ba4f24181bd2e831' }, index.h("sc-input", { key: '671e662eb364576456523acfaca1b20139270074', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && index.h("small", { key: '1caa59ca09d8902bfe910ce2056a82aac8078b67', class: "password__hint" }, this.verifyText)))));
    }
