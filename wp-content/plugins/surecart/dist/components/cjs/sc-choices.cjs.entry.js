...
const ScChoices = class {
    ...
    render() {
        return (index.h("fieldset", { key: 'a0fa373efbf774cc3d42b9c91eb8e586eb075ac2', part: "base", class: {
                'choices': true,
            ...
            }, role: "radiogroup" }, index.h("sc-form-control", { key: '488d72f2378c3c8ff1b23fd1196a81495e923ed2', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId }, index.h("div", { key: 'd4c43a547d3866e0183c4e3018ce73f0dfd28962', part: "choices", class: "choices__items" }, index.h("slot", { key: 'aad42237f7d82a10201c2efc201e096c223d2ec9' })))));
    }
