...
const ScSubscriptionPayment = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: '3fe211fcbda4491ce2813fe1a06cff3bc9fe2b1d', heading: wp.i18n.__('Select a payment method', 'surecart'), class: "subscription-payment", error: this.error }, index.h("sc-form", { key: '7b4f5a9e0502a70cfa66ca4b38685aef630c72ea', onScFormSubmit: e => this.handleSubmit(e) }, index.h("sc-card", { key: 'eefa2efce12ed5ae248761ee493a13559cda2237' }, this.renderContent())), this.busy && index.h("sc-block-ui", { key: '390b7200abf7b60a33277a76d3f83fd00cafd115' })));
    }
};
