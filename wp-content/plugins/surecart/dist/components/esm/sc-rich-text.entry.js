...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (h(Host, { key: '3bf321fb977d07358ba624974343bdbe23ac9d38' }, h("sc-form-control", { key: '13221a3f297543ab00e106e37edd83134db403e6', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: '6e795c0dfd470c729b2649dbfbf61b935f9f9c44', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, h("div", { key: '2c186edc2b39ce8f2dd6c899ca044d1781e3557a', class: "menu" }, h("sc-button", { key: '1d8ccb28613627cd4019d580726bec8cc629b3ce', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, h("sc-icon", { key: 'c6b8889160ccf6794ce433abbf45551f8de6664b', name: "bold" })), h("sc-button", { key: '30716feabc3c402d97ef6704aecde628c53f0d0c', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, h("sc-icon", { key: '11f5421a4cfc6b1d8c3b133664b183df2e5fd6ea', name: "italic" })), h("sc-button", { key: '4d9ed2ceb37edd4283100230c1c73be0d353ddd1', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, h("sc-icon", { key: 'cbd320f7fba8bae54b11587292c15602165726d8', name: "list" })), h("sc-button", { key: '5c13e6dacd3d824c8176fa9a74aac31f6339f929', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, h("sc-icon", { key: '595c767bd1edb1ad22d5f8b7618db1e865630621', name: "minus" })), h("sc-button", { key: '5a327a2b03444414b880e3ae74c77d176c4c4355', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, h("sc-icon", { key: '08aea4aac4d70237087ca4f895e87ab4eec18a7c', name: "corner-up-left" })), h("sc-button", { key: 'b6c579c22a59e08511370902d3ac3bda1e3a5d3e', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, h("sc-icon", { key: 'bb9a633d81ad65a61150440f57c49e0276ceb022', name: "corner-up-right" }))), h("div", { key: '68ea3c41cfe45f2f1e107f27eb556a232d9899df', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && h("div", { key: '55105ad6d26d155c7337610248fff06de05d4a75', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
