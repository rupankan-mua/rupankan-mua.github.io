...
const ScChoice = class {
    ...
    render() {
        return (h(Host, { key: '162d453b77a98cc328a1728274364452dcd8c342', tabindex: "0", onFocus: () => this.input.focus() }, h("div", { key: '5d3d11c3c2686e76a686d6ce11c969cd48912093', part: "base", class: {
                'choice': true,
            ...
            }, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, h("slot", { key: '8a6d8e6ac35192c51cd302ec2dc5965050021464', name: "header" }), h("label", { key: '4b98eababfa367730697f55ed9f511a994b24213', class: "choice__content", part: "content", htmlFor: this.inputId }, h("span", { key: 'e4c195ef773ef716f06560bc2b8660d5893c22c7', part: "control", class: {
                choice__control: true,
                choice__checkbox: this.type === 'checkbox',
                choice__radio: this.type === 'radio',
            }, hidden: !this.showControl }, h("span", { key: '5fc19e316c1928530f4aef57da1555cab8c832a5', part: "checked-icon", class: "choice__icon" }, this.type === 'checkbox' ? (h("svg", { viewBox: "0 0 16 16" }, h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, h("g", { stroke: "currentColor", "stroke-width": "2" }, h("g", { transform: "translate(3.428571, 3.428571)" }, h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" })))))) : (h("svg", { viewBox: "0 0 16 16" }, h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, h("g", { fill: "currentColor" }, h("circle", { cx: "8", cy: "8", r: "3.42857143" })))))), h("input", { key: 'e273d12a8d8f0df197f426b7c3ab1e31464518e1', id: this.inputId, ref: el => (this.input = el), type: this.type, name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, tabindex: "0",
            // required={this.required}
            onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), h("span", { key: 'df38e3e5fa2e5acb6b804d503cc4f4d1e1a8a62d', part: "label", id: this.labelId, class: "choice__label" }, h("span", { key: 'f0a6d933cb4443edf0adb10c7b204c747af838ab', class: "choice__label-text", hidden: !this.showLabel }, h("span", { key: '3a1f41de6f5c4bdf80a09cdf45b34936e0e8b705', class: "choice__title", part: "title" }, h("slot", { key: '07ca7057bb3c1adda427d29259c61b6923a45c14', onSlotchange: () => this.handleSlotChange() })), h("span", { key: 'ce997ac1bc9d9444ef86705b5044ff6a6338667d', class: "choice__description description", part: "description", hidden: !this.hasDescription }, h("slot", { key: '8880d72ab536b49dcb4612aefdae7273c5f8f0ae', name: "description", onSlotchange: () => this.handleSlotChange() }))), h("span", { key: '5c2e10abe9a27118a2832a67090093a6442c3095', class: "choice__price", hidden: !this.showPrice || (!this.hasPrice && !this.hasPer) }, h("span", { key: 'de425e90a68f2f3090c13dd501bc9966abd5a776', class: "choice__title" }, h("slot", { key: 'f50a0b98f479073ea350e60bfe5b5ea3d3bbf6d5', name: "price", onSlotchange: () => this.handleSlotChange() })), ' ', h("span", { key: 'e6c15318a9909864541ec9544d955fc47f30285b', class: "choice__description" }, h("slot", { key: '805201451fb083b91c17b3a6810ccd851d7ae8cb', name: "per", onSlotchange: () => this.handleSlotChange() }))))), h("slot", { key: '3a222c22e9de7d6f25e625f173d74fe45fe834ec', name: "footer" }))));
    }
