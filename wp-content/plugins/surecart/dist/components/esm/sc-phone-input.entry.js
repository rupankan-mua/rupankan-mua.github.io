...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '5245511a2f581d1ed489998b4fecf348eac1ac5c', hidden: this.hidden }, h("sc-form-control", { key: 'eb396f5b98273b0084a6041e55aea206758cf55c', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, h("slot", { key: '91e4b3579782938b52e6c03cd7578b631e86bcd4', name: "label-end", slot: "label-end" }), h("div", { key: 'd63bc3907cae92992ed4d4d19497b8e22161c772', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, h("span", { key: 'a2318aea2fb08d974859ed00367878b051ce0dce', part: "prefix", class: "input__prefix" }, h("slot", { key: '10e10c2ec59b5e843a6116cda4517ddb82b9a7eb', name: "prefix" })), h("slot", { key: '32dd459c98bd4006dbe4aa7820bd7a224d66cb05' }, h("input", { key: 'a0700165a1166c29bab30b588652ccf0486dd1d7', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), h("span", { key: '37c569c3c4b26556f659dd1f0c17b61c655e5c1d', part: "suffix", class: "input__suffix" }, h("slot", { key: '1aa73b86c8c2cd7ae20c81bf00dd400f1d5d6dd6', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (h("button", { key: 'c5c7fa1644b09de50c373849ffff65659c30ccba', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, h("slot", { key: '4169fb90b77bbd2255babe60ba97e878d68fedc8', name: "clear-icon" }, h("svg", { key: 'a7b24347a72194bf577d859e6a8c0347009858d5', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, h("line", { key: '7596dfbcb0953e8e457f1c0293850ec759add9bf', x1: "18", y1: "6", x2: "6", y2: "18" }), h("line", { key: '4a9d9ca3893361ee912a1944020ec46a5cc6a123', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
